...
int main() {
    ...
    const Student& top_student = findTopStudent(students, num_students);
    std::cout << "The most successful student: " << top_student.name << " (GPA: " << calculateAverage(top_student) << ")\n";

    std::cout << std::endl;

    int count_above_75 = countStudentsAbove75(students, num_students);
